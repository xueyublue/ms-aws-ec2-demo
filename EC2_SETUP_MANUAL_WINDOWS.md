...
- GitHub CI/CD setup (Windows): `CICD_SETUP_MANUAL_WINDOWS.md`
- GitHub CI/CD setup (macOS): `CICD_SETUP_MANUAL_MAC.md`
...
2. Create SQS policy with actions:
  - `sqs:SendMessage`
  - `sqs:ReceiveMessage`
  - `sqs:DeleteMessage`
  - `sqs:GetQueueAttributes`
3. Attach policy to role and attach role to EC2 instance.
